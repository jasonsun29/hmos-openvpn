...
>
> **进度（2026-08-15）**：**P3 全部 15 项 + 全局模式重构完成**。第一批 ✅（t32/t30/t31/t34/t35）、第二批 ✅（t36/t40/t37）、第三批 ✅（t38/t39/t41/t42）、第四批 ✅（t43/t33/t44：release 构建分支 / bindSheet 对话框 / Navigation 迁移）。全局模式重构（离线选端点 + 默认全局 + 订阅解耦映射，替代 yaml 补丁方案）代码层验证通过。**剩余唯一待办：真机回归**（全局模式重构 + 第四批，待设备连接）。
